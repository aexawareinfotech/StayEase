        ...
        {error ? (
          ...
          <div className="space-y-6">
            {bookings.map((b) => (
              <div
                key={b._id}
                className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 flex flex-col md:flex-row gap-6 relative"
              >
                ...
                <div className="w-full md:w-3/4 flex flex-col justify-between pt-6 md:pt-0">
                  <div>
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span
                        className={`px-4 py-1.5 rounded-full text-sm font-bold shadow-sm inline-block ${
                          b.status === "confirmed"
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                    <div className="bg-blue-50 p-3 rounded-lg text-center">
                      <p className="text-xs text-blue-800 font-semibold mb-1 border-b border-blue-200 pb-1">
                        Check-in
                      </p>
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg text-center">
                      <p className="text-xs text-gray-600 font-semibold mb-1 border-b border-gray-200 pb-1">
                        Guests
                      </p>
                      <p className="text-sm font-bold text-gray-800">
                        {b.guests}
                    ...
                    <div className="bg-green-50 p-3 rounded-lg text-center border border-green-200 shadow-sm">
                      <p className="text-xs text-green-800 font-semibold mb-1 border-b border-green-200 pb-1">
                        Total Price
                      </p>
                    ...
                    {b.status === "confirmed" && (
                      <>
                        <button
                          ...
                          className="bg-blue-50 hover:bg-blue-100 text-blue-600 border border-blue-200 hover:border-blue-300 font-bold py-2.5 px-6 rounded-xl transition duration-150 shadow-sm"
                        >
                          Modify Booking
                        </button>
                        <button
